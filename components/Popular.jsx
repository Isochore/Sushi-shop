    ...
    return (
        <section className="popular-foods" id="menu">
            ...
            <article className="popular-foods__card">
                <img className="popular-foods__card-image" src="assets/sushi-12.png" alt="sushi-12" />
            ...
            <article className="popular-foods__card active-card">
                <img className="popular-foods__card-image" src="assets/sushi-11.png" alt="sushi-11" />
            ...
            <article className="popular-foods__card">
                <img className="popular-foods__card-image" src="assets/sushi-10.png" alt="sushi-10" />
